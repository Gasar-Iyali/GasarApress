...
<body>
    ...
    <!-- Center Column Content Section -->
       <div class="col-sm-8">
          <h2 class="text-center">Welcome to the Home Page of Zack Amata's Interactive Web Page!!</h2><img src="images/DSC_0011.JPG" alt="" style="padding-right:10px;padding-bottom:5px;float:left;width:400px">
