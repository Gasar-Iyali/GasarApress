...
<body>
    ...
    <!-- Center Column Content Section -->
       <div class="col-sm-8">
          <h2 class="text-center">Welcome to Page Four of Zack Amata's Interactive Web Page!!</h2><img src="images/D.jpg" alt="" style="padding-right:10px;padding-bottom:5px;float:left;width:400px">
